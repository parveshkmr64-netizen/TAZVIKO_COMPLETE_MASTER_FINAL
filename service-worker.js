const CACHE='tazviko-v1';
const CORE=['./','./index.html','./offline.html','./manifest.webmanifest','./js/app-config.js','./js/api-client.js','./js/pwa.js','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
